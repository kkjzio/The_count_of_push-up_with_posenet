...
sys.path.insert(0, osp.join(r'POSENET/', 'main1'))
sys.path.insert(0, osp.join(r'POSENET/', 'data1'))
sys.path.insert(0, osp.join(r'POSENET/', 'common'))
sys.path.insert(0, osp.join(r'POSENET/common/', 'utils'))
...
model_path = r'model_data/snapshot_24.pth'
